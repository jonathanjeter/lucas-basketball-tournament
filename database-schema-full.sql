-- Basketball Tournament Database Schema (Full Version with Sample Data) - SECURE VERSION
-- Execute this script in your Supabase SQL Editor
-- This version includes tables, functions, AND sample data with correct foreign key relationships
...
-- FOREIGN KEY FIX: Insert sample data with proper UUID consistency
-- First, insert teams with specific UUIDs for foreign key relationships
INSERT INTO teams (id, team_name, contact_name, contact_email, contact_phone, age_category, registration_type, entry_fee_paid, approved, status, donation_amount) VALUES
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Lightning Bolts', 'John Smith', 'john.smith@email.com', '(555) 123-4567', 'middle-school', 'full-team', true, true, 'approved', 50.00),
('b2c3d4e5-f6g7-8901-bcde-f12345678901', 'Thunder Hawks', 'Sarah Johnson', 'sarah.j@email.com', '(555) 987-6543', 'high-school-adult', 'full-team', false, false, 'pending', 30.00);

-- Insert players with matching team_id foreign keys
...
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Alex Smith', 'alex@email.com', '7th', 'middle-school', '2011-05-15', 'John Smith', '(555) 123-4567', true),
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'Jamie Wilson', 'jamie@email.com', '8th', 'middle-school', '2010-08-22', 'Lisa Wilson', '(555) 234-5678', true),
('b2c3d4e5-f6g7-8901-bcde-f12345678901', 'Taylor Brown', 'taylor@email.com', 'adult', 'high-school-adult', '1998-03-10', 'Mike Brown', '(555) 345-6789', false);

-- Insert sponsors with specific UUIDs for foreign key relationships
INSERT INTO sponsors (id, sponsor_name, contact_name, email, phone, company, donation_type, donation_amount, sponsor_level, approved, display_on_website) VALUES
('c3d4e5f6-g7h8-9012-cdef-123456789012', 'Local Auto Shop', 'Bob Martinez', 'bob@autoshop.com', '(555) 555-0123', 'Martinez Auto Repair', 'monetary', 150.00, 'silver', true, true),
('d4e5f6g7-h8i9-0123-def1-234567890123', 'Pizza Palace', 'Maria Garcia', 'maria@pizzapalace.com', '(555) 555-0456', 'Pizza Palace Restaurant', 'items', 0, 'bronze', true, true),
('e5f6g7h8-i9j0-1234-ef12-345678901234', 'Community Bank', 'David Lee', 'david@communitybank.com', '(555) 555-0789', 'First Community Bank', 'monetary', 300.00, 'gold', false, true);
...
-- FOREIGN KEY FIX: Insert payments with correct team_id and sponsor_id foreign keys
INSERT INTO payments (team_id, sponsor_id, payment_type, amount, payment_method, payment_status, transaction_id) VALUES
('a1b2c3d4-e5f6-7890-abcd-ef1234567890', NULL, 'registration', 30.00, 'cash', 'completed', 'CASH-001'),
(NULL, 'c3d4e5f6-g7h8-9012-cdef-123456789012', 'donation', 150.00, 'check', 'completed', 'CHECK-001');
...
-- Success message
DO $$ BEGIN
    RAISE NOTICE '✅ Basketball Tournament Database Schema Created Successfully (SECURE FULL VERSION)!';
    RAISE NOTICE '📊 Tables created: teams, players, sponsors, volunteers, payments, admin_users, tournament_brackets, contact_inquiries';
    RAISE NOTICE '🔗 Sample data inserted with correct foreign key relationships';
    ...
    RAISE NOTICE '   - 2 teams with 3 players total';
    RAISE NOTICE '   - 3 sponsors (2 approved, 1 pending)';
    RAISE NOTICE '   - 3 volunteers (2 approved, 1 pending)';
    RAISE NOTICE '   - 2 completed payments totaling $180';
    RAISE NOTICE '   - 2 contact inquiries';
    RAISE NOTICE '';
